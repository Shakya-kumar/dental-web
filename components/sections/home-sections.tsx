...
const faqs = [
  {
    ...
    answer:
      "Yes. Online consultations are supported with structured follow-ups and WhatsApp guidance."
  },
  {
    question: "Do plans include Indian food preferences?",
    answer:
      "Yes. Plans are practical, locally relevant and designed around sustainable habits."
  },
  {
    question: "How quickly can I book a consultation?",
    answer:
      "Submit the form or WhatsApp the clinic team for the fastest available slot."
  }
];
  ...
  return (
    <section className="relative overflow-hidden bg-white">
      <div className="container grid min-h-[calc(100vh-4rem)] items-center gap-10 py-12 lg:grid-cols-[1.05fr_0.95fr]">
        ...
        {/* RIGHT IMAGE SECTION */}
        <div className="relative min-h-[420px] overflow-hidden rounded-2xl bg-muted shadow-clinical">
          ...
          {/* Floating Stats */}
          <div className="absolute bottom-4 left-4 right-4 grid gap-3 rounded-xl bg-white/92 p-4 backdrop-blur-md sm:grid-cols-3">
        ...
        <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
          ...
          <div>
            ...
            <h2 className="mt-3 font-serif text-3xl font-bold">
              Built for trust before the first call.
            </h2>

            <p className="mt-4 leading-7 text-muted-foreground">
              The platform presents medical credibility, patient outcomes,
              structured process and immediate WhatsApp access in a
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {services.map((service) => (
              <div
                key={service}
                className="rounded-xl border border-border bg-white p-5 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
              >
        ...
        {[
          {
            icon: ShieldCheck,
            title: "Trust",
            text: "Clear expertise, safe messaging and proof points."
          },
          {
            icon: Activity,
            title: "Clarity",
            text: "Services, process and outcomes explained quickly."
          },
          {
            icon: LineChart,
            title: "Action",
            text: "Sticky CTAs, WhatsApp and appointment forms."
          }
        ].map((item) => (
          <div
            key={item.title}
            className="rounded-xl border border-border p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
          >
    ...
    <section className="bg-background py-16">
      <div className="container grid gap-10 lg:grid-cols-2">
        ...
        <div>
          ...
          <h2 className="mt-3 font-serif text-3xl font-bold">
            Transformation proof without clutter.
          </h2>
          ...
          <div className="mt-6 grid gap-4">
            ...
            {[
              ...
              "Improved thyroid lifestyle",
              "Better PCOS food confidence"
            ].map((quote) => (
              <div
                key={quote}
              ...
              >
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  Verified patient journey placeholder
                </p>
              </div>
            ))}
        ...
        <div>
          ...
          <h2 className="mt-3 font-serif text-3xl font-bold">
            Answers that reduce booking friction.
          </h2>
    ...
    <section id="appointment" className="bg-white py-16">
      <div className="container grid gap-10 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <div>
          ...
          <h2 className="mt-3 font-serif text-3xl font-bold">
            Book a consultation request in under a minute.
          </h2>

          <p className="mt-4 leading-7 text-muted-foreground">
            Every form submission creates a structured lead or appointment
            record and nudges the patient to WhatsApp for faster confirmation.
          </p>
        </div>

        <div className="rounded-xl border border-border bg-background p-5 shadow-clinical">
          <AppointmentForm />
        </div>
